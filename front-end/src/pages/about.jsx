...
const About = () => {
    let matter = "Hey folks, I am Mundlamuri Mahesh. I live in Prakasam, Andhra Prdesh. I love using 🧑‍💻 Software as a solution for every problem. I am interested in learning 🤓 new things. I did my graduation at NIT Agartala 🏫. Currently, I’m looking for oppurtunities and open for an intern or a full time job opportunity."
            ...
            <div className="btech-degree-container" style={{ position: "relative", width: "100%" }}>
                    ...
                    <div className="" style={{ position: "relative", marginTop: "50px" }}>
                        ...
                        <div className="bottom-hire" style={{ width: "100%" }}>
                            ...
                            <p style={{ marginTop: "10px" }}>
                                <FormDialog />
                                &nbsp; <NavLink to="https://wa.me/7993918088?text=Hi%20Mahesh!%20I%20like%20your%20portfolio%20and%20want%20to%20get%20connected%20with%20you" target="_blank" text="I'm%20interested%20in%20your%20car%20for%20sale"><Button type='submit' variant="outlined" color="error">Ping Me &nbsp; <i className="fa-brands fa-whatsapp"></i></Button></NavLink>
                            </p>
                        </div>
                    </div>
                ...
                <div className="btech-degree-letter-container" style={{ position: "relative" }}>
                    ...
                    <div style={{ marginTop: "-240px", paddingBottom: "75px", zIndex: "5", position: "relative" }}>
                        <h1 className="text-center pacifico-regular patta-name-1"><span style={{ color: "crimson" }}>M</span>ahesh Mundlamuri</h1>
