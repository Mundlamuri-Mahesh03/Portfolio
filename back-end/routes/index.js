...
const username = "Mundlamuri Mahesh";
...
router.post("/send-mail", async (req, res) => {
  ...
  let bodyofEmail = `<div style='font-size:large; font-family: sans-serif'>
        <h3 class="protest-riot-regular", >Hey <span>${data.name}</span>,</h3><p>Thanks for contacting me.  </p>
        ...
        <p>- -<br>Best Regards<br> <a href="https://www.linkedin.com/in/mundlamuri-mahesh03/" target="_blank"
            style="font-weight:bold; text-decoration: underline; color: crimson;">Mundlamuri Mahesh</a></p>
            </div>
        `;
...
router.post("/send-hiring-mail", async (req, res) => {
  ...
  let bodyofEmail = `<div style='font-size:large; font-family: sans-serif'>
        ...
        <p>I'll reach out to you shortly <b>:)</b></p>
        <p>- -<br>Best Regards<br> <a href="https://www.linkedin.com/in/mundlamuri-mahesh03/" target="_blank"
            style="font-weight:bold; text-decoration: underline; color: crimson;">Mahesh Mundlamuri</a></p>
            </div>
        `;
...
const SendMail = async (data, bodyofEmail) => {
  try {
    await transporter
      .sendMail({
        from: `"Mahesh's PortFolio" ${process.env.SMTP_USER_NAME}`,
        to: data.email,
